...
df_capit_solar <- read.csv(paste0(file_path, "/per-capita-solar.csv"),header=TRUE)
...
df_capit_nuclear <- read.csv(paste0(file_path, "/per-capita-nuclear.csv"),header=TRUE)
# Per capita energy consumption from wind
df_capit_nuclear <- read.csv(paste0(file_path, "/per-capita-wind.csv"),header=TRUE)
# Per capita energy consumption from fossil
df_capit_nuclear <- read.csv(paste0(file_path, "/fossil-fuels-per-capita.csv"),header=TRUE)
# Per capita energy consumption from oil
df_capit_nuclear <- read.csv(paste0(file_path, "/per-capita-oil.csv"),header=TRUE)
# Per capita energy consumption from gas
df_capit_nuclear <- read.csv(paste0(file_path, "/per-capita-gas.csv"),header=TRUE)
# Per capita energy consumption from coal
df_capit_nuclear <- read.csv(paste0(file_path, "/per-capita-coal.csv"),header=TRUE)
...
df <- merge(df_capacity,df_capita, by="Year", all = TRUE) #to fill the non existent values with NA
...
colnames(df) <- c("pv.module.price", "pv.module.capacity", "installed.energy.capacity", "share.prod.from.solar")
