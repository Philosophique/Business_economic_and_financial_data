...
df$mean_energy_capita <-  apply(df[,5:11],1,mean)

SS <- capita_solar_spain$Solar.per.capita..kWh...equivalent.[25:57]
SN <- capita_nuclear$Nuclear.per.capita..kWh...equivalent.[4:57]
SW <- capita_wind$Wind.per.capita..kWh...equivalent.[25:57]
SF <- capita_fossil$Fossil.fuels.per.capita..kWh.[1:57]
SG <- capita_gas$Gas.per.capita..kWh.[5:57]
SO <- capita_oil$Oil.per.capita..kWh.[1:57]
SC <- capita_coal$Coal.per.capita..kWh.[1:57]
S_all_energy <- df$mean_energy_capita[1:57]

##Competition between solar and nuclear

#plot of two series
plot(capita_nuclear$Year[4:57], SN, xlab = "year", ylab="Consumption per capita",type= "b", pch=16, lty=3, cex=0.7)
...
lines(capita_solar_spain$Year[25:57], (ucrcdNS$fitted.i[[2]]), lwd=2, col=2)
...
abline(v=1995, lty=2)
text(2009, 0.8, pos=4, "Wind vs solar")


#competition between solar and fossil

#plot of two series
plot(capita_fossil$Year[1:57], SF, xlab = "year", ylab="Consumption per capita",type= "b", pch=16, lty=3, cex=0.7)
points(capita_solar_spain$Year[25:57], SS,type= "b", pch=16, lty=3, cex=0.7, col=2)
...
lines(capita_fossil$Year[1:57], (ucrcdFS$fitted.i[[1]]), lwd=2, col=1)
lines(capita_solar_spain$Year[25:57], (ucrcdFS$fitted.i[[2]]), lwd=2, col=2)

abline(v=1989, lty=2)
text(2009, 0.8, pos=4, "Fossil vs solar")
...
#plot of two series
plot(capita_gas$Year[5:57], SG, xlab = "year", ylab="Consumption per capita",type= "b", pch=16, lty=3, cex=0.7)
points(capita_solar_spain$Year[25:57], SS,type= "b", pch=16, lty=3, cex=0.7, col=2)
...
lines(capita_gas$Year[5:57], (ucrcdGS$fitted.i[[1]]), lwd=2, col=1)
lines(capita_solar_spain$Year[25:57], (ucrcdGS$fitted.i[[2]]), lwd=2, col=2)

abline(v=1989, lty=2)
text(2005, 0.8, pos=4, "Gas vs solar")


#competition between solar and oil

#plot of two series
plot(capita_oil$Year[1:57], SO, xlab = "year", ylab="Consumption per capita",type= "b", pch=16, lty=3, cex=0.7)
points(capita_solar_spain$Year[25:57], SS,type= "b", pch=16, lty=3, cex=0.7, col=2)
...
lines(capita_oil$Year[1:57], (ucrcdOS$fitted.i[[1]]), lwd=2, col=1)
lines(capita_solar_spain$Year[25:57], (ucrcdOS$fitted.i[[2]]), lwd=2, col=2)

abline(v=1989, lty=2)
text(2005, 0.8, pos=4, "Oil vs solar")
...
#plot of two series
plot(capita_coal$Year[1:57], SC, xlab = "year", ylab="Consumption per capita",type= "b", pch=16, lty=3, cex=0.7)
points(capita_solar_spain$Year[25:57], SS,type= "b", pch=16, lty=3, cex=0.7, col=2)
...
lines(capita_coal$Year[1:57], (ucrcdCS$fitted.i[[1]]), lwd=2, col=1)
lines(capita_solar_spain$Year[25:57], (ucrcdCS$fitted.i[[2]]), lwd=2, col=2)

abline(v=1989, lty=2)
text(1990, 0.8, pos=4, "Coal vs solar")
...
S <- capita_solar_spain$Solar.per.capita..kWh...equivalent.[25:57]
G <- capita_solar_germany$Solar.per.capita..kWh...equivalent.[26:57]
C <-  capita_solar_china$Solar.per.capita..kWh...equivalent.[26:57]
U <- capita_solar_usa$Solar.per.capita..kWh...equivalent.[19:57]

#competition between Spain and Germany

#plot of two series
plot(capita_solar_germany$Year[26:57], G, xlab = "year", ylab="Consumption per capita",type= "b", pch=16, lty=3, cex=0.7)
...
lines(capita_solar_germany$Year[26:57], (ucrcdGS$fitted.i[[1]]), lwd=2, col=1)
lines(capita_solar_spain$Year[25:57], (ucrcdGS$fitted.i[[2]]), lwd=2, col=2)
...
#plot of two series
plot(capita_solar_usa$Year[19:57], U, xlab = "year", ylab="Consumption per capita",type= "b", pch=16, lty=3, cex=0.7)
points(capita_solar_spain$Year[25:57], S,type= "b", pch=16, lty=3, cex=0.7, col=2)
