...
ccf_spain_portugal <- ccf(res.portugal, res.spain,10, main = "Portugal vs Spain", col = 7, lwd = 4, ci.col = 7, cex.lab = 1.5) # Spain leads Portugal (positive cross correlation at lag 2) 
dev.off()
...
ccf_spain_portugal <- ccf(res.germany, res.spain,10, main = "Germany vs Spain", col = 7, lwd = 4, ci.col = 7, cex.lab = 1.5) #Germany leads Spain (negative cross correlation at lag 6)
dev.off()

png(file="plots/france_vs_spain.png", width=14,height=12,units="cm",res=1200, pointsize=6)
ccf_spain_portugal <- ccf(res.france, res.spain,10, main = "France vs Spain", col = 7, lwd = 4, ci.col = 7, cex.lab = 1.5) # Spain leads France (positive cross correlation at lag 2) 
dev.off()
...
ucrcdNS <-UCRCD(SN,SS, display=T, m2 = 12431) #the only one that gives me error
summary(ucrcdNS)
...
points(dfcapita_solar_spain$Year[25:57],SS, type= "b", pch=16, lty=3, cex=0.7, col=7)
