...
plot(x = df$Year[25:57], cap_solar_SP, type= "b", xlab="Year", ylab="Per capita consumption (kWh)",  pch=16, lty=3, cex=0.6, xlim=c(1989,2025), ylim=c(0,2200))
...
plot(x = df$Year[25:57], cap_solar_SP, type= "b", xlab="Year", ylab="Per capita consumption (kWh)",  pch=16, lty=3, cex=0.6, xlim=c(1989,2030), ylim=c(0,2700))
...
plot(x = df$Year[25:57], cap_solar_SP, type= "o", xlab="Year", ylab="Per capita consumption (kWh)", pch=16, lty=1, cex=0.6, xlim=c(1989,2023), ylim=c(0,2700))
...
plot(for1, xaxt = 'n', xlab="Year", ylab="Per capita consumption (kWh)", type= "b", pch=16, lty=3, cex=0.6)
...
plot(df$Year[25:57],cap_solar_SP, type= "o",xlab="Year", ylab="Per capita consumption (kWh)",  pch=16, lty=1, cex=0.6, col = 1)
lines(df$Year[25:57], fit_GBM_SP_inst, lwd=2, lty=1, col = 2)
lines(df$Year[25:57], fitted(auto_with_reg), lty=1,lwd=2, col=7)
