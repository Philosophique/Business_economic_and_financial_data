...
png(file="consumption_countries.png", width=14,height=12,units="cm", res=1200, pointsize=6)
plot(df2$Year, df2$Capita.solar.india, type = "b", col = 6, ylim = c(1,2000), xlab="Year", ylab="Consumption (kWh)", main="Per capita solar energy consumption", cex.lab = 1.5, cex.main = 1.8)
lines(df2$Year, df2$Capita.solar.china, type = "b", col = 3)
lines(df2$Year, df2$Capita.solar.germany, type = "b", col = 1)
lines(df2$Year, df2$Capita.solar.world, type = "b", col = 7)
lines(df2$Year, df2$Capita.solar.australia, type = "b", col = 5)
lines(df2$Year, df2$Capita.solar.spain, type = "b", col = 2)
lines(df2$Year, df2$Capita.solar.usa, type = "b", col = 4)
...
png(file="generation.png", width=14,height=12,units="cm",res=1200, pointsize=6)
plot(df2$Year, df2$Generation.world, type = "b", col = 7, ylim = c(1,350), xlab="Year", ylab="Generation (TWh)", main= "Solar power generation", cex.lab = 1.5, cex.main = 1.8)
lines(df2$Year, df2$Generation.china, type = "b", col = 3)
lines(df2$Year, df2$Generation.germany, type = "b", col = 1)
lines(df2$Year, df2$Generation.spain, type = "b", col = 2)
lines(df2$Year, df2$Generation.australia, type = "b", col = 5)
lines(df2$Year, df2$Generation.india, type = "b", col = 6)
lines(df2$Year, df2$Generation.usa, type = "b", col = 4)
...
png(file="consumption_energies.png", width=14,height=12,units="cm",res=1200, pointsize=6)
plot(df2$Year, df2$Capita.solar.spain, type = "o", col = 7, ylim = c(1,25000), xlab="Year",ylab = "Consumption (kWh)", main ="Per capita solar energy consumption", cex.lab = 1.5, cex.main = 1.8)
lines(df2$Year, df2$Capita.oil, type = "o", col = 2)
lines(df2$Year, df2$Capita.nuclear, type = "o", col = 3)
lines(df2$Year, df2$Capita.gas, type = "o", col = 6)
lines(df2$Year, df2$Capita.wind, type = "o", col = 4)
lines(df2$Year, df2$Capita.coal, type = "o", col = 1)
legend("topright", legend=c("Solar", "Wind", "Nuclear", "Coal", "Gas",
                       "Oil"),
...
png(file="prices.png", width=14,height=12,units="cm",res=1200, pointsize=6)
plot(df2$Year, df2$PV.price, type = "o", col = 7, xlab="Year", ylab = "Price (($/W))", main="Solar PV module prices", lwd = 1.5, cex.lab = 1.5, cex.main = 1.8)
dev.off()

png(file="capacity.png", width=14,height=12,units="cm",res=1200, pointsize=6)
plot(df2$Year, df2$PV.capacity, type = "o", col = 7, xlab="Year", ylab = "Capacity (GW)", main ="Solar PV capacity", lwd = 1.5, cex.lab = 1.5, cex.main = 1.8)
dev.off()

png(file="share.png", width=14,height=12,units="cm", res=1200, pointsize=6)
plot(df2$Year, df2$PV.capacity, type = "o", col = 7, xlab="Year", ylab = "Share (%)", main ="Share of electricity production from solar", lwd = 1.5, cex.lab = 1.5, cex.main = 1.8)
dev.off()
...
tt<- df$Year[25:57] #1:NROW(cap_solar_SP)
...
plot(x = df$Year[25:57], cap_solar_SP,  xlab="Year", ylab="Solar per capita kWh", type= "b",  pch=16, lty=3, cex=0.6) #from 1989 to 2021
...
##plot of the model
plot(tt, cap_solar_SP, xlab="Time", ylab="Solar per capita kWh", type= "b",  pch=16, lty=3, cex=0.6)
abline(fit1, col=3)
...
plot(tt, resfit1,xlab="Time", ylab="residuals", type= "b",  pch=16, lty=3, cex=0.6)
...
plot(cap_solar_SP, x = df$Year[25:57], type= "b",xlab="Year", ylab="Solar per capita kWh",  pch=16, lty=3, cex=0.6)
plot(cumsum(cap_solar_SP), x = df$Year[25:57], type="b", xlab="Year", ylab="Solar per capita kWh",  pch=16, lty=3, cex=0.6)
...
plot(x = df$Year[25:57], cap_solar_SP, type= "b",xlab="Year", ylab="Solar per capita kWh",  pch=16, lty=3, cex=0.6)
...
############################################################################
###### this and the next cell are exactly the same as the cell above #######
############################################################################
...
### 
plot(cap_solar_SP, type= "b",xlab="Year", ylab="Solar per capita kWh",  pch=16, lty=3, cex=0.6)
...
plot(x = df$Year[25:57], cap_solar_SP, type= "b",xlab="Year", ylab="Solar per capita kWh",  pch=16, lty=3, cex=0.6)
lines(x = c(1989:2022), pred.inst_SP75[1:34], lwd=2, col=2)
lines(x = c(1989:2022), pred.inst_SP[1:34], lwd=2, col=4)



###Comparison between models (cumulative)
plot(x = df$Year[25:57], cumsum(cap_solar_SP), type= "b",xlab="Year", ylab="Annual sales",  pch=16, lty=3, cex=0.6)
...
plot(x = df$Year[25:57], cap_solar_SP, type= "b",xlab="Quarter", ylab="Quarterly revenues",  pch=16, lty=3, cex=0.6, xlim=c(1989,2025), ylim=c(0,2200))
lines(x = c(1989:2023), pred_GBM_SP_e2.inst[1:35], lwd=2, col=2)
...
plot(x = df$Year[25:57], cap_solar_SP, type= "b",xlab="Quarter", ylab="Quarterly revenues",  pch=16, lty=3, cex=0.6, xlim=c(1989,2030), ylim=c(0,2700))
lines(x = c(1989:2030), pred_GGM_SP.inst[1:42], lwd=2, col=2)
```
...
# Plot Arima model
plot(x = df$Year[25:57], cap_solar_SP, type= "b", pch=16, lty=3, cex=0.6)
lines(x = c(1989:2022), fitted(arima1)[1:34], col=2)
...
# Plot fitting
plot(x = df$Year[25:57], cap_solar_SP,type= "b", pch=16, lty=3, cex=0.6)
lines(x = c(1989:2022), fitted(auto.a)[1:34], col=2)
...
```{r PV modules influence on cap_solar_SP, results=}
# Let's see the influence of the price of PV modules

price <- df$PV.price[25:57]
plot(x = df$Year[25:57],price,type= "b", pch=16, lty=3, cex=0.6)
acf(price)
pacf(price)
...
fitted(armax1)
plot(x = df$Year[25:57], cap_solar_SP,type= "b", pch=16, lty=3, cex=0.6)
lines(x = c(1989:2022),fitted(armax1)[1:34], col = 2)
...
```{r PV modul capacity influence on cap_solar_SP, results=}
...
plot(x = df$Year[25:57],capacity,type= "b", pch=16, lty=3, cex=0.6)
acf(capacity)
pacf(capacity)
...
fitted(mod)
plot(x = df$Year[25:57], cap_solar_SP.ts, type= "b",xlab="Year", ylab="Solar per capita kWh",  pch=16, lty=3, cex=0.6)
lines(x = c(1989:2022), fitted(mod)[1:34], col = 2)

# Analysis of residuals - autocorelation?
plot(x = df$Year[25:57],residuals(mod),type= "b",xlab="Year", ylab="Residuals",  pch=16, cex=0.6)
...
plot(x = df$Year[25:57],cap_solar_SP.ts, type= "b",xlab="Year", ylab="Solar per capita kWh",  pch=16, lty=3, cex=0.6)
lines(x = c(1989:2022), fitted(mod)[1:34]+fitted(aar)[1:34], col = 3)
...
#make plot
plot(x = df$Year[32:57], df_p_c$PV.capacity, xlab = "Time", ylab = "Solar Capacity")
plot(x = df$Year[32:57], df_p_c$PV.price, xlab = "Time", ylab = "Solar PV Price")
...
#####Study of comsuption of solar vs nuclear, wind, fossil, gas, oil, coal.

df$mean_energy_capita <-  apply(df[,5:11],1,mean) #this i dont get it
...
S_all_energy <- df$mean_energy_capita[1:57] #THIS IS NULL, HAVE TO CHECK
...
#plot of two series
plot(df$Year[4:57], SN, xlab = "Year", ylab="Consumption per capita",type= "b", pch=16, lty=3, cex=0.7)
points(df$Year[25:57], SS, type= "b", pch=16, lty=3, cex=0.7, col=2)

ucrcdNS <-UCRCD(SN,SS, display=T) #the only one that gives me error
summary(ucrcdNS)


plot(year, SN, xlab="year", ylab="Consumption per capita", type="b",pch=16, lty=3, cex=0.7)
points(dfcapita_solar_spain$Year[25:57],SS, type= "b", pch=16, lty=3, cex=0.7, col=2)
...
plot(df$Year[25:57], SW, xlab = "Year", ylab="Consumption per capita",type= "b", pch=16, lty=3, cex=0.7)
points(df$Year[25:57],SS, type= "b", pch=16, lty=3, cex=0.7, col=2)
...
plot(capita_wind$Year[25:57], SW, xlab="Year", ylab="Consumption per capita", type="b",pch=16, lty=3, cex=0.7)
points(capita_solar_spain$Year[25:57], SS, type= "b", pch=16, lty=3, cex=0.7, col=2)
lines(capita_wind$Year[25:57], (ucrcdWS$fitted.i[[1]]), lwd=2, col=1)
lines(capita_solar_spain$Year[25:57], (ucrcdWS$fitted.i[[2]]), lwd=2, col=2)

abline(v=1995, lty=2) #THIS I THINK DOESNT MAKE SENSE
...
plot(df$Year[1:57], SF, xlab = "Year", ylab="Consumption per capita",type= "b", pch=16, lty=3, cex=0.7, ylim = c(0,35000))
points(df$Year[25:57], SS, type= "b", pch=16, lty=3, cex=0.7, col=2)
...
lines(df$Year[25:57], (ucrcdFS$fitted.i[[2]]), lwd=2, col=2)
abline(v=1989, lty=2)
...
plot(df$Year[25:57], SW, xlab="year", ylab="Consumption per capita", type="b",pch=16, lty=3, cex=0.7)
points(df$Year[25:57],SS, type= "b", pch=16, lty=3, cex=0.7, col=2)
lines(df$Year[25:57], (ucrcdWS$fitted.i[[1]]), lwd=2, col=1)
lines(df$Year[25:57], (ucrcdWS$fitted.i[[2]]), lwd=2, col=2)

#abline(v=1995, lty=2) #SAME, NO SENSE FOR ME
...
plot(df$Year[1:57], SO, xlab = "year", ylab="Consumption per capita",type= "b", pch=16, lty=3, cex=0.7, ylim = c(0,21000))
points(df$Year[25:57], SS, type= "b", pch=16, lty=3, cex=0.7, col=2)
...
lines(df$Year[25:57], (ucrcdOS$fitted.i[[2]]), lwd=2, col=2)
abline(v=1989, lty=2)
...
plot(df$Year[5:57], SG, xlab = "year", ylab="Consumption per capita",type= "b", pch=16, lty=3, cex=0.7)
points(df$Year[25:57], SS,type= "b", pch=16, lty=3, cex=0.7, col=2)
...
lines(df$Year[25:57], (ucrcdGS$fitted.i[[2]]), lwd=2, col=2)
abline(v=1989, lty=2)
...
plot(df$Year[1:57], SC, xlab = "year", ylab="Consumption per capita",type= "b", pch=16, lty=3, cex=0.7,  ylim = c(0,6500))
points(df$Year[25:57], SS,type= "b", pch=16, lty=3, cex=0.7, col=2)
...
lines(df$Year[25:57], (ucrcdCS$fitted.i[[2]]), lwd=2, col=2)
abline(v=1989, lty=2)
...
```{r results = 'asis'}
#Competition solar vs mean of all energy per capita 

#THIS HAS TO BE CHECKED BECAUSE S_ALL_ENERGY IS NULL, DO WE NEED THIS??


plot(df$Year[1:57], S_all_energy, xlab = "year", ylab="Consumption per capita",type= "b", pch=16, lty=3, cex=0.7)
points(df$Year[25:57], SS,type= "b", pch=16, lty=3, cex=0.7, col=2)

ucrcd_all_energy <- UCRCD(S_all_energy,SS, display=T)
summary(ucrcd_all_energy)


plot(df$Year[1:57], S_all_energy, xlab="year", ylab="Consumption per capita", type="b",pch=16, lty=3, cex=0.7)
points(capita_solar_spain$Year[25:57],SS, type= "b", pch=16, lty=3, cex=0.7, col=2)

lines(df$Year[1:57], (ucrcd_all_energy$fitted.i[[1]]), lwd=2, col=1)
lines(capita_solar_spain$Year[25:57], (ucrcd_all_energy$fitted.i[[2]]), lwd=2, col=2)

abline(v=1989, lty=2)
text(1990, 0.8, pos=4, "All energy vs solar")
...
```{r Competition spain vs Germany, China, USA, results=}
### Study of comsuption of energy solar per capita of Spain vs Germany, China, USA

S <- cap_solar_SP
G <- df$Capita.solar.germany[26:57]
C <- df$Capita.solar.china[26:57]
U <- df$Capita.solar.usa[19:57]
...
```{r results = 'asis'}
#competition between Spain and Germany

#plot of two series
plot(df$Year[26:57], G, xlab = "year", ylab="Consumption per capita",type= "b", pch=16, lty=3, cex=0.7)
points(df$Year[25:57], S,type= "b", pch=16, lty=3, cex=0.7, col=2)

ucrcdGS <- UCRCD(G,S, display=T)
summary(ucrcdGS)


plot(df$Year[26:57], G, xlab="year", ylab="Consumption per capita", type="b",pch=16, lty=3, cex=0.7)
points(df$Year[25:57],S, type= "b", pch=16, lty=3, cex=0.7, col=2)
lines(df$Year[26:57], (ucrcdGS$fitted.i[[1]]), lwd=2, col=1)
lines(df$Year[25:57], (ucrcdGS$fitted.i[[2]]), lwd=2, col=2)

abline(v=1989, lty=2)
text(1990, 0.8, pos=4, " Germany vs Spain")

############################ MAKES MORE SENSE TO START WITH SPAIN

plot(capita_solar_spain$Year[25:57], S, xlab = "year", ylab="Consumption per capita",type= "b", pch=16, lty=3, cex=0.7)
points(capita_solar_germany$Year[26:57], G,type= "b", pch=16, lty=3, cex=0.7, col=2)

ucrcdGS <- UCRCD(S,G, display=T)
summary(ucrcdGS)


plot(capita_solar_spain$Year[25:57],S, xlab="year", ylab="Consumption per capita", type="b",pch=16, lty=3, cex=0.7)
points(capita_solar_germany$Year[26:57],G, type= "b", pch=16, lty=3, cex=0.7, col=2)
lines(capita_solar_spain$Year[25:57], (ucrcdGS$fitted.i[[1]]), lwd=2, col=1)
lines(capita_solar_germany$Year[26:57], (ucrcdGS$fitted.i[[2]]), lwd=2, col=2)
...
```{r results = 'asis'}
#Competition spain vs china

#plot of two series
plot(capita_solar_china$Year[26:57], C, xlab = "year", ylab="Consumption per capita",type= "b", pch=16, lty=3, cex=0.7)
points(capita_solar_spain$Year[25:57], S,type= "b", pch=16, lty=3, cex=0.7, col=2)

ucrcdCS <- UCRCD(C,S, display=T)
summary(ucrcdCS)


plot(capita_solar_china$Year[26:57], C, xlab="year", ylab="Consumption per capita", type="b",pch=16, lty=3, cex=0.7, ylim=c(0,1800))
points(capita_solar_spain$Year[25:57],S, type= "b", pch=16, lty=3, cex=0.7, col=2)
lines(capita_solar_china$Year[26:57], (ucrcdCS$fitted.i[[1]]), lwd=2, col=1)######################################################
lines(capita_solar_spain$Year[25:57], (ucrcdCS$fitted.i[[2]]), lwd=2, col=2)

abline(v=1989, lty=2)
text(1990, 0.8, pos=4, "Spain vs China")


######################## SAME HERE, SPAIN STARTS ONE YEAR BEFORE

plot(capita_solar_spain$Year[25:57], S, xlab = "year", ylab="Consumption per capita",type= "b", pch=16, lty=3, cex=0.7)
points(capita_solar_china$Year[26:57], C,type= "b", pch=16, lty=3, cex=0.7, col=2)

ucrcdCS <- UCRCD(S,C, display=T)
summary(ucrcdCS)


plot(capita_solar_spain$Year[25:57], S, xlab = "year", ylab="Consumption per capita",type= "b", pch=16, lty=3, cex=0.7, ylim = c(0,1800))
points(capita_solar_china$Year[26:57], C,type= "b", pch=16, lty=3, cex=0.7, col=2)
lines(capita_solar_spain$Year[25:57], (ucrcdCS$fitted.i[[1]]), lwd=2, col=1)######################################################
lines(capita_solar_china$Year[26:57], (ucrcdCS$fitted.i[[2]]), lwd=2, col=2)
...
```{r results = 'asis'}
#Competition Spain vs USA

#plot of two series
plot(capita_solar_usa$Year[19:57], U, xlab = "year", ylab="Consumption per capita",type= "b", pch=16, lty=3, cex=0.7, ylim=c(0,1800))
points(capita_solar_spain$Year[25:57], S,type= "b", pch=16, lty=3, cex=0.7, col=2)

ucrcdUS <- UCRCD(U,S, display=T)
summary(ucrcdUS)


plot(capita_solar_usa$Year[19:57], U, xlab="year", ylab="Consumption per capita", type="b",pch=16, lty=3, cex=0.7, ylim=c(0,1800))
points(capita_solar_spain$Year[25:57],S, type= "b", pch=16, lty=3, cex=0.7, col=2)
lines(capita_solar_china$Year[19:57], (ucrcdUS$fitted.i[[1]]), lwd=2, col=1)
lines(capita_solar_spain$Year[25:57], (ucrcdUS$fitted.i[[2]]), lwd=2, col=2)

abline(v=1989, lty=2)
text(2010, 0.8, pos=4, "Spain vs USA")
...
m1 <- lm(Capita.solar.spain ~ ., data=data.train)
summary(m1)
...
pred.lm <- predict(m2, newdata=data.test)
deviance.lm <- sum((pred.lm-data.test$Capita.solar.spain)^2)
deviance.lm
...
gamodel <- gam(Capita.solar.spain ~ ., data=data.train)
...
sc = gam.scope(data.train[,-5], response=5, smoother = "s", arg=c("df=2","df=3","df=4")) # arg specifies some degrees of freedom (df = 1 linear fit...)
gamscope<- step.Gam(gamodel, scope=sc, trace=T, direction = c("both"))
sc2 = gam.scope(data.train[,-5], response=5, smoother = "lo", arg=c("df=2","df=3","df=4")) # loess smoother
...
gam.m1 = gam(Capita.solar.spain ~ s(Capita.solar.china ,2) + s(Capita.gas,4) ,data= data.train)
gam.m2 = gam(Capita.solar.spain ~ s(Capita.solar.china ,2) + s(Capita.gas,4) + lo(Share.from.solar, 3) , data= data.train)
gam.m3 = gam(Capita.solar.spain ~ s(Capita.solar.china ,2) + s(Capita.gas,4) + lo(Share.from.solar, 3) + lo(Capita.fossil, df = 2) , data= data.train)
gam.m4 = gam(Capita.solar.spain ~ s(Capita.solar.china ,2) + s(Capita.gas,4) + lo(Share.from.solar, 3) + lo(Capita.fossil, df = 2) + Capita.nuclear, data= data.train)
gam.m5 = gam(Capita.solar.spain ~ s(Capita.solar.china ,2) + s(Capita.gas,4) + lo(Share.from.solar, 3) + lo(Capita.fossil, df = 2) + Capita.nuclear + Capita.wind , data= data.train)
gam.m6 = gam(Capita.solar.spain ~ s(Capita.solar.china ,2) + s(Capita.gas,4) + lo(Share.from.solar, 3) + lo(Capita.fossil, df = 2) + Capita.nuclear + Capita.wind + Capita.oil , data= data.train)
...
dev.tree <- sum((p.tree-data.test$Capita.solar.spain)^2)
dev.tree
...
# 1 Boosting- 
boost.capita = gbm(Capita.solar.spain ~ ., data=data.train, 
...
plot(boost.capita$train.error, type="l", ylab="training error")

#always decreasing with increasing number of trees
#
#
#relative influence plot
summary(boost.capita) 
...
summary(boost.capita, las=1, cBar=10) # cbar to say how many variables in the plot
...
plot(boost.capita$train.error, type="l")
...
boost.capita.deeper=gbm(Capita.solar.spain ~ ., data=data.train, 
...
boost.capita.lr=gbm(Capita.solar.spain ~ ., data=data.train, bag.fraction = 0.95, 
...
boost.capita.comb=gbm(Capita.solar.spain ~ . ,data=data.train, bag.fraction = 0.95,
...
summary(boost.capita.comb, las=1, cBar=10) 
...
# Bagging
rf.capita= randomForest(Capita.solar.spain ~ ., data=data.train , mtry = 13, importance = TRUE, ntree = 250) # All 13 predictors considered = bagging is done
...
# Random Forest
rf.capita= randomForest(Capita.solar.spain ~ ., data=data.train , mtry = 6, importance = TRUE, ntree = 200)
