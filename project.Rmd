...
```{r results = 'asis'}
#Analyzing relationship between Installed solar energy capacity and solar PV modul price
...
sc = gam.scope(data.train[,-5], response=5, arg=c("df=2","df=3","df=4")) # arg specifies some degrees of freedom (df = 1 linear fit...)
gamscope<- step.Gam(gamodel, scope=sc, trace=T)
summary(gamscope)
AIC(gamscope)
