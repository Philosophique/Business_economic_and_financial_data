...
plot(acf1, type = "h", xlab = "Lag", main = "Autocorrelation of solar consumption", col = 7, lwd = 4, ci.col = 7, cex.lab = 1.5)
...
res1 <- Acf(res)
plot(res1, type = "h", xlab = "Lag", main = "Autocorrelation of residuals", col = 7, lwd = 4, ci.col = 7, cex.lab = 1.5)
...
plot(res2, type = "h", xlab = "Lag", main = "Autocorrelation of residuals", col = 7, lwd = 4, ci.col = 7, cex.lab = 1.5)
...
plot(res3, type = "h", xlab = "Lag", main = "Autocorrelation of residuals", col = 7, lwd = 4, ci.col = 7, cex.lab = 1.5)
...
plot(acf2, type = "h", xlab = "Lag", main = "Autocorrelation of solar consumption", col = 7, lwd = 4, ci.col = 7, cex.lab = 1.5)


pacf <- Pacf(cap_solar_SP)
plot(pacf, type = "h", xlab = "Lag", main = "Partial autocorrelation of solar consumption", col = 7, lwd = 4, ci.col = 7, cex.lab = 1.5)
...
# Do forecast
plot(forecast(auto.a, 5), xaxt='n', xlab="Year", ylab="Per capita consumption (kWh)", type= "b", pch=16, lty=3, cex=0.6)
axis(1, at = seq(1, 38, by=5), labels=seq(1989, 2026, by=5))
...
plot(df$Year[25:57],cap_solar_SP, type= "b", xlab="Year", ylab="Per capita consumption (kWh)",  pch=16, lty=3, cex=0.6, col = 1)
...
plot(forecast(auto_with_reg, xreg = pred_GGM_SP.inst[34:39]), xaxt='n', xlab="Year", ylab="Per capita consumption (kWh)", type= "b", pch=16, lty=3, cex=0.6)
axis(1, at = seq(1, 42, by=5), labels=seq(1989, 2030, by=5))
...
plot(res4, type = "h", xlab = "Lag", main = "Autocorrelation of residuals", col = 7, lwd = 4, ci.col = 7, cex.lab = 1.5)
...
res5 <- Acf(res_all)
plot(res5, type = "h", xlab = "Lag", main = "Autocorrelation of residuals", col = 7, lwd = 4, ci.col = 7, cex.lab = 1.5)
...
plot(res6, type = "h", xlab = "Lag", main = "Autocorrelation of residuals", col = 7, lwd = 4, ci.col = 7, cex.lab = 1.5)
...
#plot of two series
plot(df$Year[4:57], SN, xlab="Year", ylab="Per capita consumption (kWh)", type= "b", pch=16, lty=3, cex=0.7)
...
plot(year, SN, xlab="Year", ylab="Per capita consumption (kWh)", type="b",pch=16, lty=3, cex=0.7)
...
plot(df$Year[25:57], SW, xlab="Year", ylab="Per capita consumption (kWh)", type= "b", pch=16, lty=3, cex=0.7)
points(df$Year[25:57],SS, type= "b", pch=16, lty=3, cex=0.7, col=2)
...
plot(capita_wind$Year[25:57], SW, xlab="Year", ylab="Per capita consumption (kWh)", type="b",pch=16, lty=3, cex=0.7)
...
plot(df$Year[1:57], SF, xlab="Year", ylab="Per capita consumption (kWh)", type= "b", pch=16, lty=3, cex=0.7, ylim = c(0,35000))
points(df$Year[25:57], SS, type= "b", pch=16, lty=3, cex=0.7, col=2)
...
plot(df$Year[1:57], SO, xlab="Year", ylab="Per capita consumption (kWh)", type= "b", pch=16, lty=3, cex=0.7, ylim = c(0,21000))
points(df$Year[25:57], SS, type= "b", pch=16, lty=3, cex=0.7, col=2)
...
plot(df$Year[5:57], SG, xlab="Year", ylab="Per capita consumption (kWh)", type= "b", pch=16, lty=3, cex=0.7)
points(df$Year[25:57], SS,type= "b", pch=16, lty=3, cex=0.7, col=2)
...
plot(df$Year[1:57], SC, xlab="Year", ylab="Per capita consumption (kWh)", type= "b", pch=16, lty=3, cex=0.7,  ylim = c(0,6500))
points(df$Year[25:57], SS,type= "b", pch=16, lty=3, cex=0.7, col=2)
